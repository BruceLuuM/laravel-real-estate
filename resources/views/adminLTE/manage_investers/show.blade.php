...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Invester Detail</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Invester Detail</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Invester Detail</h3>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-8">
                            <h3 class="my-3">{{$invester->name}} Review</h3>
                            <div class="row">
                                <div class="col-12 col-sm-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            <span class="info-box-text text-center text-muted">Giá trị tập đoàn</span>
                                            <span class="info-box-number text-center text-muted mb-0">2300
                                                (Example)</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            <span class="info-box-text text-center text-muted">Số Dự án đang triển
                                                khai</span>
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{$invester->nums_project}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            <span class="info-box-text text-center text-muted"> Số dự án đang gọi
                                                vốn</span>
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{$invester->nums_project}}</span>
                                        </div>
                            ...
                            <div class="text-center mt-5 mb-3">
                                <a href="{{route('adminEditInvester',['invester'=>$invester->id])}}"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="tab-content p-3" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                                aria-labelledby="product-desc-tab"> {!!$invester->description!!}
                            </div>
...
<!-- /.content -->
@endsection
@push('script_invester_image_change')
<script>
